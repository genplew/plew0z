...
str_debug			db	0dh, 0ah, 'Plewos_Debug_String', 0
str_not386			db	0dh, 0ah, 'Un CPU 386+ es requerido.', 0
str_loaddisk   		db	0dh, 0ah, 'Cargando en cache: 00 %', 8, 8, 8, 8, 0
str_memmovefailed	db	0dh, 0ah, 'Fatal - No se pudo copiar.', 0
str_badsect			db	0dh, 0ah, 'Fatal - Sistema no legible.', 0
str_memsizeunknow	db	0dh, 0ah, 'Fatal - Cantidad de memoria desconocida.', 0
str_notenoughmem	db	0dh, 0ah, 'Fatal - Sin memoria. Minimo 16M', 0
...
boot_str_rcpuid				db	'Leyendo modelo del CPU...', 0
boot_str_rpirqs				db	'Configurando peticiones de interrupcion...', 0

boot_str_setitss			db	'Configurando Segmento de estado de tarea...', 0
boot_str_setitssdesc		db	'Configurando GDT con Segmento de estados...', 0
boot_str_setitaskgate		db	'Configurando IDT con puerta de tareas...', 0

boot_str_setrdfs			db	'Configurando ramdisk sistema de archivos...', 0

boot_str_setsysctss			db	'Configurando llamadas a Segmentos...', 0
boot_str_setsysctssdesc		db	'Configurando GDT con llamadas a segmentos...', 0
boot_str_setsysctaskgate	db	'Configurando IDT...', 0

boot_str_setptss			db	'Configurando procesos de segmentos...', 0
boot_str_setpcb				db	'Configurando procesos control de bloques...', 0
boot_str_setptssdesc		db	'Configurando GDT con procesos de descripcion...', 0
boot_str_setptaskgate		db	'Configurando GDT con puerta e tareas...', 0
boot_str_setprocessseg		db	'Configurando GDT con procesos de bloques...', 0

boot_str_settimer			db	'Configurando Tiempo(8259)...', 0
boot_str_setostask			db	'Configurando procesos del sistema...', 0
boot_str_enirqs				db	'Activando peticiones de interrupcion...', 0

boot_str_initshell			db	'Inicializando Shell...', 0

boot_str_presenter			db	'Configurado correctamente! Pulsa Enter para continuar!', 0

shell_path					db	'\shell', 0

promot_row		db	0
promot_ok		db	'[ PASO ]', 0
promot_failed	db	'[FALLO]', 0
