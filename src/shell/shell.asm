...
;db	'********************************************************************************'
copyright	db	'*********** Interfaz de interaccion para control del kernel de plew0z **********'
			db	'***************  Sistemas y datos protegidos con algoritmo alpha  **************', 0dh, 0ah, 0
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;debug string
...
estr_maxcount			db	'Sin memoria para mas aplicaciones!', 0
estr_notfoundfille		db	'Aplicacion no encontrada!', 0
estr_invalidforma		db	'Formato de comando invalido!', 0
